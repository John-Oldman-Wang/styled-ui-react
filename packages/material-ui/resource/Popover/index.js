...
class Popover extends React.Component {
  ...
  getAnchorOffset(contentAnchorOffset) {
    ...
    if (anchorReference === 'anchorPosition') {
      warning(
        anchorPosition,
        'Material-UI: you need to provide a `anchorPosition` property when using ' + '<Popover anchorReference="anchorPosition" />.'
      );
  ...
  render() {
    ...
    return (
      <Modal classes={ModalClasses} container={container} open={open} BackdropProps={{ invisible: true }} {...other}>
        <TransitionComponent
          appear
          in={open}
          onEnter={onEnter}
