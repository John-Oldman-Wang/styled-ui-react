...
function InputAdornment(props) {
  ...
  if (variantProp && muiFormControl) {
    warning(
      ...
      'Material-UI: The `InputAdornment` variant infers the variant property ' + 'you do not have to provide one.'
    );
  }
...
export default withStyles(styles, { name: 'MuiInputAdornment' })(withFormControlContext(InputAdornment));
