...

{
  ...
  const defaulted = <TextField InputProps={{ classes: { inputTypeSearch: 'search-input', input: 'input' } }} />;
  const standard = <TextField variant="standard" InputProps={{ classes: { inputTypeSearch: 'search-input' } }} />;
  ...
  const outlined = <TextField variant="outlined" InputProps={{ classes: { notchedOutline: 'notched-outline' } }} />;
}
