...
class Tabs extends React.Component {
  ...
  getConditionalElements = () => {
    const { classes, scrollable: deprecatedScrollable, ScrollButtonComponent, scrollButtons, theme, variant } = this.props;
    const conditionalElements = {};
    const scrollable = variant === 'scrollable' || deprecatedScrollable;
    conditionalElements.scrollbarSizeListener = scrollable ? <ScrollbarSize onChange={this.handleScrollbarSizeChange} /> : null;
        ...
        warning(
          ...
          [
            ...
            this.valueToIndex.keys
              ? `You can provide one of the following values: ${Array.from(this.valueToIndex.keys()).join(', ')}.`
              : null
          ].join('\n')
        );
  ...
  updateIndicatorState(props) {
    ...
    if (tabMeta && tabsMeta) {
      const correction =
        theme.direction === 'rtl' ? tabsMeta.scrollLeftNormalized + tabsMeta.clientWidth - tabsMeta.scrollWidth : tabsMeta.scrollLeft;
    ...
    if (
      (indicatorStyle.left !== this.state.indicatorStyle.left || indicatorStyle.width !== this.state.indicatorStyle.width) &&
  ...
  render() {
    ...
    const children = React.Children.map(childrenProp, (child) => {
      ...
      warning(
        ...
        ["Material-UI: the Tabs component doesn't accept a Fragment as a child.", 'Consider providing an array instead.'].join('\n')
      );
