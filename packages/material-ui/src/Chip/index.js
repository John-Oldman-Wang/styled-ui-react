...
class Chip extends React.Component {
  ...
  render() {
    ...
    if (onDelete) {
      ...
      deleteIcon =
        deleteIconProp && React.isValidElement(deleteIconProp) ? (
          ...
          <CancelIcon className={classNames(classes.deleteIcon, customClasses)} onClick={this.handleDeleteIconClick} />
        );
    }
    ...
    warning(
      !avatar || !icon,
      'Material-UI: the Chip component can not handle the avatar ' + 'and the icon property at the same time. Pick one.'
    );
